                ...
                <div className="overflow-auto flex-1">
                  <table className="w-full text-left border-collapse relative">
                    ...
                    <tbody>
                      {suites
                        .filter((suite: any) => {
                          const matchesSearch = (suite.suite || "")
                            .toLowerCase()
                        ...
                        .map((suite: any, i: number) => {
                          const isExpanded =
                            suiteSearch.trim() !== "" || expandedSuites.has(i);
                                    ...
                                    <div className="bg-slate-50/50 dark:bg-surface-dark/30 border-b border-slate-100 dark:border-border-brand">
                                      {suiteTests.length === 0 ? (
                                        <div className="px-10 py-3 text-[11px] text-slate-400 italic">
                                          No individual test data available for
                                          this suite.
                                        </div>
                                      ) : (
                            ...
                            >
                              <div className="flex flex-col items-center justify-center gap-2">
                                ...
                                <p className="text-[11px] opacity-70">
                                  We couldn't find any test cases matching your
